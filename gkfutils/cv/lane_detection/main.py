...
if __name__=='__main__':
    ...
    parser.add_argument("--imgpath", type=str, default=r'G:\Gosion\code\Ultra-Fast-Lane-Detection-v2-opencv-onnxrun-main\onnxruntime\images\culane\00000.jpg', help="image path")
    parser.add_argument("--modelpath", type=str, default=r'G:\Gosion\code\Ultra-Fast-Lane-Detection-v2-opencv-onnxrun-main\weights\ufldv2_culane_res18_320x1600.onnx', help="onnx modelpath")
    # parser.add_argument("--imgpath", type=str, default=r'G:\Gosion\data\006.Belt_Torn_Det\data\seg\3d_seg\images\image1.jpg', help="image path")
